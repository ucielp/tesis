...
#~ do
    ...
    #~ # Tengo que hacer solo las sustituciones en el fasta no en el nombre
...
#~ do
    ...
    #~ t_coffee -other_pg seq_reformat -in $filename.fasta_aln -in3 $filename.fasta_aln -action +3evaluate idmat -output=score_html -out=$filename.html
#~ done
#~ 
#~ rm *.score_html
#~ rm *.dnd 
