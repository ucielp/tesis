...
Precursores con distintos mecanísmos de procesamiento deberían tener elementos estructurales distintos. 
	\uncover<2->{
		Anotación arbitraria en miRBASE.
		\begin{itemize}
...
\begin{frame}{¿Cuál es el ortólogo en otras especies?}
	\begin{center}
		\includegraphics[width=1\textwidth]{img/ortologos_defensa.png}
	\end{center}
\end{frame}
...
%~ \begin{frame}{}
	%~ \begin{center}
		%~ \includegraphics[width=1\textwidth]{img/agradecimientos02.png}
	%~ \end{center}
%~ \end{frame}
