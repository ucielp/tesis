...
\begin{frame}{Esquema de la estrategia para la identificación de nuevos genes blancos}
	\begin{center}
		\includegraphics[width=0.7\textwidth]{img/NAR_fig1_01.png}
	\end{center}
\end{frame}

\begin{frame}{Esquema de la estrategia para la identificación de nuevos genes blancos}
	\begin{center}
		\includegraphics[width=0.7\textwidth]{img/NAR_fig1_02.png}
	\end{center}
\end{frame}
...
\begin{frame}{Esquema de la estrategia para la identificación de nuevos genes blancos}
	\begin{center}
		\includegraphics[width=0.7\textwidth]{img/NAR_fig1_03.png}
	\end{center}
\end{frame}
...
\begin{frame}{Esquema de la estrategia para la identificación de nuevos genes blancos}
	\begin{center}
		\includegraphics[width=0.7\textwidth]{img/NAR_fig1_04.png}
	\end{center}
\end{frame}
...
\begin{frame}{Conclusiones I}
	\begin{itemize}
        ...
        \uncover<2->{   \begin{center}
                            \includegraphics[width=.7\textwidth]{img/tabla_targets.png}
                        \end{center}
        }
	\end{itemize}
\end{frame}
