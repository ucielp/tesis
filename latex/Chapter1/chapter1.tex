...
A partir de la estrategia descrita en el capítulo anterior, que fue utilizada para encontrar y validar experimentalmente genes blanco regulados por miARNs en Arabidopsis thaliana, desarrollamos una herramienta web denominada comTAR\footnote{http://rnabiology.ibr-conicet.gov.ar/comtar} (Conserved plant miRNA target prediction tool) \citep{Chorostecki2014}.
...
\subsubsection{Buscar potenciales genes blanco de miARN}
...
\subsubsection{Buscar familias de potenciales genes blanco de miARN}
...
\subsubsection{¿Es este gen un potencial gen blanco de algun miARN conservado?}
...
\subsubsection{Buscar tu secuencia particular}
...
\begin{figure}[htbp!] 
    ...
    \caption[]{Resultados de la búsqueda con parámetros por defecto para el miR398}
...
\begin{figure}[htbp!] 
    ...
    \caption[]{Parte de la salida de comTAR mostrando el par miR398/SOD1 (At1g12520) en diferentes especies}
