...
\subsubsection{miR164a}
%~ Natural Variation in Biogenesis
%~ Efficiency of Individual
%~ Arabidopsis thaliana MicroRNAs
Se ha demostrado recientemente que un polimorfismo de origen natural que ocurre en el gen del miR164a afecta a la forma de la hoja y la arquitectura del vástago en \textit{A. thaliana}, cpn los efectos de ser modificados por loci adicionales en el genoma \citep{pmid22206705}.
...
The replacement of a G:C in MIR164A Col-0 with
a non-Watson-Crick G:U pair in MIR164A C24 slightly increases
the calculated free energy of the foldback from 265.3 to
262.9 kcal/mol, but should not modify the secondary structure
of MIR164A
