...
En ambos casos, se pudo observar que la región con mayor conservación conincide con el dúplex miARN/miARN* pero además se puede ver una región conservada por debajo del dúplex, que coincide con el tallo inferior.
...
Nos pusimos a analizar esta familia en detalle para ver si los patrones de conservación y estructura secundaria eran diferentes o no (Figura \ref{fig:familia_miR171_circos}).
