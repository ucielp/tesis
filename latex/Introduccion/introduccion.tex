...
Este proceso se utiliza para que las células se ajusten a los cambios en su ambiente de manera de optimizar el desarrollo, la respuesta celular al stress y al entorno, entre muchos otros procesos.
...
Estos ARN pequeños comparten algunos elementos entre ellos, como que son producidas a partir de precursores de ARN doble hebra, son procesados del ARNdh para librerar el ARN pequeño y la metilación del extremo 3' del ARN pequeño. 

\subsection{Variedades de ARN pequeños en plantas}
La clase más abundante son los siARNs (small interfering RNAs), que son ARN pequeños de 21 a 26 nt derivados del procesamiento de largas moléculas de ARN doble hebra de origen endógeno o exógeno.
...
Un método denominado PARE (Construction of Parallel Analysis of RNA Ends) \citep{pmid19247285} fue desarrollado para la identificación de genes blanco de miARNs y estudios del degradoma de ARN, mediante técnicas de alto rendimiento. 	
...
CleaveLand \citep{pmid19017659} es un pipeline computacional para la detección de cortes de miARNs en datos de degradoma.
...
Por otro lado, la herramienta PAREsnip permite realizar búsqueda de potenciales genes blanco de todos los RNA pequeños obtenidos de técnicas de secuenciación de alto rendimiento.
Mediante la búsqueda de genes blanco de todo el "sRNAome" se pude facilitar identificación de genes blanco de RNA pequeños a grande escala.
