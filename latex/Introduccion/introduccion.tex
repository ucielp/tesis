...
\subsection{Precursores en plantas}
...
Por último, la herramienta p-TAREF \citep{pmid22206472} implementa "support vector regression" (RVS) y utiliza la información de la "variación de la densidad de dinucleótido" alrededor del sitio blanco de un conjunto de datos de \textit{A. thaliana}, \textit{Oryza sativa}, \textit{Medicago truncatula} y \textit{Solanum lycopersicum}.
