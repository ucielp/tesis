...
\begin{figure}[htbp!] 
    \centering    
    \includegraphics[width=.7\textwidth]{procesamiento_animales.png}
...
El paso final de la biogénesis de los miARN es la incorporación asimétrica, a partir del dúplex miARN-miARN*, del miARN maduro dentro de un complejo de silenciamiento, mientras que el miARN* en su mayoría se degrada.
...
Muchos precursores en plantas tienen un tallo de $\sim$15 nt debajo del dúplex miARN/miARN* seguido por un loop interno, que sirve como una señal estructural de reconocimiento por la maquinaria de procesamiento \citep{pmid17369351,pmid16751099,Mateos2010,pmid20015654} (Figura \ref{fig:ss_precursores}).
Sin embargo, este determinante de procesamiento no se encuentra en todos los precursores \citep{Mateos2010}.
Además, la biogénesis de los miARNs conservados evolutivamente como ser el miR319 y miR159 comienzan con un corte al lado del loop terminal y continúa con 3 cortes adicionales en una dirección de burbuja a base hasta que finalmente el miARN es liberado \citep{Bologna2013,pmid19850910} (Figura \ref{fig:ss_precursores}).
Se ha demostrado que otros precursores de plantas liberan otros ARNs pequeños además del miARN \citep{pmid15314213,pmid20696037}, aunque no se conoce función biológica para estos otros miARNs.
En principio, podrían ser una consecuencia secundaria del mecanismo de biogénesis del miR319.
...
Nos referimos como desajuste (utilizaremos el término en Inglés: ``mismatches' el resto de la Tesis) a cualquier interacción entre pares de bases que no sean interacciones G-C o A-U 
...
\begin{figure}[htbp!] 
	...
	\caption[Interacción de miARN-ARNm blanco]{
        ...
        Las líneas verticales grises representan bases apareadas, la ausencia de líneas representa ``mismatches''.
	}
